...
trainingData='<nameOfExcludedBird>_<obstacleHeight>_<speed>_dataTrainValidation'; 
...
saveAs = [trainingData(1:end-20), '_network.mat']; %naming convension: nameOfExcludedBird_obstacleHeight_speed_...
save(saveAs, 'NN', 'pStruct');